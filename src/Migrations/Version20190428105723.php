 ...
 */
final class Version20190428105723 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE car (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, brand VARCHAR(50) NOT NULL, model VARCHAR(50) NOT NULL, image VARCHAR(15) DEFAULT NULL, is_chating TINYINT(1) NOT NULL, is_smoking TINYINT(1) NOT NULL, is_music TINYINT(1) NOT NULL, is_pets TINYINT(1) NOT NULL, max_passangers INT NOT NULL, INDEX IDX_773DE69DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
