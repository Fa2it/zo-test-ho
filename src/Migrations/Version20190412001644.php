 ...
 */
final class Version20190412001644 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE act_code (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, email_code VARCHAR(5) NOT NULL, phone_code VARCHAR(6) NOT NULL, UNIQUE INDEX UNIQ_BF9CD17DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
