 ...
 */
final class Version20190509223549 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON, password VARCHAR(255) NOT NULL, first_name VARCHAR(40) NOT NULL, last_name VARCHAR(40) NOT NULL, phone_nr VARCHAR(12) DEFAULT NULL, date_of_birth DATE NOT NULL, is_email TINYINT(1) NOT NULL, is_phone TINYINT(1) NOT NULL, photo VARCHAR(23) NOT NULL, sex VARCHAR(1) NOT NULL, ip_address VARCHAR(40) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ride (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, car_id INT NOT NULL, pick_up VARCHAR(255) NOT NULL, drop_off VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, pick_up_date DATETIME NOT NULL, pick_up_time TIME NOT NULL, drop_off_time TIME NOT NULL, drop_off_date DATETIME NOT NULL, passengers INT NOT NULL, price INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_9B3D7CD0A76ED395 (user_id), INDEX IDX_9B3D7CD0C3C6F69F (car_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
